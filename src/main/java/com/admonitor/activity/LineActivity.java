...
//        setData1();
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                if(res==null){
                    Toast.makeText(LineActivity.this, "请求超时，请检查网络", Toast.LENGTH_LONG).show();
                }else {
                    ...
                    if (json.getString("flag").equals("1")) {
                        ...
                        intent.setClass(LineActivity.this, LoginActivity.class);
                        ...
                        if(jsonArray.length()!=0){
                            ...
                            Toast.makeText(LineActivity.this, "暂无数据，稍后重试", Toast.LENGTH_LONG).show();
                        }
                    } else {
...
//            Toast.makeText(MapActivity.this,""+(int)status.zoom,Toast.LENGTH_LONG).show();
    ...
    BaiduMap.OnMarkerClickListener listener = new BaiduMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker){
            ...
            intent.setClass(LineActivity.this,DetailActivity.class);
            startActivity(intent);
