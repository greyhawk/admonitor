...
//        vParams.height = 800;
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.zhuye_05);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.zhuye_0999);
                }
                //设置点的间距
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.zhuye_0999);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.zhuye_05);
